import { openBlock, createElementBlock, createElementVNode, normalizeStyle, Fragment, renderList, normalizeClass, pushScopeId, popScopeId } from 'vue';
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("div", {
    ...
    (openBlock(), createElementBlock("svg", _hoisted_3$1, [
      createElementVNode("clipPath", _hoisted_4$1, [
    ...
    createElementVNode("div", {
      ...
      style: normalizeStyle('left: ' + $data.sliderWidth + '%')
    }, null, 4 /* STYLE */),
    createElementVNode("div", {
      class: "sliderButton left",
      style: normalizeStyle('left: ' + ($data.sliderWidth-1) + '%')
    }, null, 4 /* STYLE */),
    createElementVNode("div", {
...
const _withScopeId = n => (pushScopeId("data-v-1363c60a"),n=n(),popScopeId(),n);
const _hoisted_1 = ["src"];
const _hoisted_2 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/createElementVNode("button", { class: "btn nextButton" }, null, -1 /* HOISTED */));
const _hoisted_3 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/createElementVNode("button", { class: "btn prevButton" }, null, -1 /* HOISTED */));
const _hoisted_4 = { class: "bullets" };

function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("div", {
    class: "carousel",
    style: normalizeStyle($options.carouselHeight)
  }, [
    (openBlock(true), createElementBlock(Fragment, null, renderList($data.loadedImages, (image, index) => {
      return (openBlock(), createElementBlock("img", {
        ...
        key: image,
        src: image,
        style: normalizeStyle($options.position(index))
    ...
    createElementVNode("div", _hoisted_4, [
      (openBlock(true), createElementBlock(Fragment, null, renderList($data.loadedImages, (image, index) => {
        return (openBlock(), createElementBlock("div", {
          key: index,
          class: normalizeClass(["bullet", index == $data.curIndex?'activeBullet':''])
        }, null, 2 /* CLASS */))
      }), 128 /* KEYED_FRAGMENT */))
    ])
  ], 4 /* STYLE */))
